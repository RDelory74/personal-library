<template>
  <div class="flex flex-col gap-1 p-3 my-10 w-auto">
    ...
    <CardBaseCodeCards
        title="Base Contact CSS"
        :code="Code1"
    >
      <ContactFormBaseContact/>
    </CardBaseCodeCards>

    <CardBaseCodeCards
        title="Contact Tailwind Lite"
        :code="Code2"
    >
    ...
    <CardBaseCodeCards
        title="Styled Quick Tooch Contact Css"
        :code="Code4"
    >
      <BaseContactStyleLite/>
    </CardBaseCodeCards>
